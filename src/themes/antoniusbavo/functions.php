<?php
/**
 * antoniusbavo functions and definitions.
 *
 ...
 */
function antoniusbavo_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'antoniusbavo' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'antoniusbavo' ),
 ...
 */
function antoniusbavo_scripts() {
	wp_enqueue_style( 'antoniusbavo-style', get_stylesheet_uri() );

	wp_enqueue_script( 'antoniusbavo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'antoniusbavo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
