(function(jQuery) {
    jQuery(document).ready(function () {
        ...
        jQuery( '#wpu_settings .subsubsub a.tab' ).click( function ( e ) {
            ...
            if ( jQuery( this ).hasClass( 'all' ) ) {
                jQuery( '#wpu_settings h3, #wpu_settings form p, #wpu_settings table.form-table, p.submit' ).show();
            ...
            jQuery( '#wpu_settings h3, #wpu_settings form > p:not(".submit"), #wpu_settings table' ).hide();
