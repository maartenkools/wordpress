    ...
    <div class="main-content">
        <div class="content-area">
            <div class="site-content" role="main">
                ...
                <?php if (!empty($ids)): ?>
                    <?php query_posts(array('category__not_in' => $ids)) ?>
                <?php endif; ?>
                <?php if (have_posts()) : ?>
                            ...
                            <div class="entry-main">
                                <div class="entry-header">
                                    ...
                                    <div class="entry-meta">
                                        <span class="entry-date-sub"><a
                                                href="<?php echo get_day_link('', '', ''); ?>"><?php echo get_the_date("M d, Y"); ?></a></span>
                                        <span class="entry-category"><?php _e("Categories", "onetone"); ?>
                                ...
                                <div class="entry-footer">
                                    <div class="entry-meta">
                                        <span class="entry-more"><a
                                                href="<?php the_permalink(); ?>">>><?php _e("Read More", "onetone"); ?></a></span>
                                    </div>
                                </div>
                            </div>
