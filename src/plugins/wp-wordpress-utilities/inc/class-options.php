...
class WPU_Options
{
    ...
    public function getValue($section, $name)
    {
        ...
        if ($optionDefinition == null) throw new InvalidArgumentException(WPU_String::format('No option definition found with the specified name ({0}) and section ({1}).', array($name, $section)));
