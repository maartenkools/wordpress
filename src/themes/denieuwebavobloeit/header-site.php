 ...
 */
global $wp_query;
$cssClass = $wp_query->is_404
    ? 'error404'
    : '';
?>
<!DOCTYPE html>
<html <?php language_attributes(); ?> class="<?php echo $cssClass; ?>">
<head>
            ...
            if (isset($section_num) && is_numeric($section_num) && $section_num > 0):
                for ($i = 0; $i < $section_num; $i++) {
                    ...
                    if (isset($section_menu) && $section_menu != "") {
                        ...
                        $onepage_menu .= '<li  class="menuitem"><a id="onetone-' . $sanitize_title . '" href="' . $siteUrl . '#' . $sanitize_title . '" >
